...
the residuals is average close to zero and seem to have a pattern, the fit result is not good,
it is no meaningful but without useless, 
and the model fit is reasonable but due to the residuals, we need to cautious.
